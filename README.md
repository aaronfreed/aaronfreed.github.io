...
In case that wasn&rsquo;t enough, I also run a **[YouTube channel](https://youtube.com/@MarathonVidmaster)** and host repositories of **[*Marathon* film files](https://github.com/aaronfreed/marathonfilms)** and **[https://github.com/aaronfreed/marathonsounds](*Marathon* sounds)** (both the original in-game versions and my remastered/remixed versions).
